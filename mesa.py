...
class mainwindow(Frame):
    ...
    def run(self, *args):
        ...
        if var.dp_check.get() == 1:
            ...
            self.printself.tcost.config(text=self.tcost)
            self.tcost = 0
        ...
        #Program code
            ...
            self.delivery_entry = Entry(root, textvariable=address)
            ...
            self.pick_pizza1 = ttk.Combobox(root, state="readonly", textvariable=pset1)
            ...
            self.pick_pizza2 = ttk.Combobox(root, state="readonly", textvariable=pset2)
            ...
            self.pick_pizza3 = ttk.Combobox(root, state="readonly", textvariable=pset3)
            ...
            self.pick_pizza4 = ttk.Combobox(root, state="readonly", textvariable=pset4)
            ...
            self.pick_pizza5 = ttk.Combobox(root, state="readonly", textvariable=pset5)
...
class receiptwindow(Toplevel):
    def __init__(self, master=None):
            ...
            self.master.protocol("WM_DELETE_WINDOW", pass)
    ...
    def run(self, *args):
            ...
            self.print_self.cost_label = Label(self, text="Total cost:            $")
            self.print_self.cost_label.grid(column=1, row=10, pady=2)
            self.printself.tcost = Label(self, text="")
            self.printself.tcost.grid(column=2, row=10, pady=2)
            ...
            self.cancelwindow = Button(self, text="Cancel", command=cancel_rself.order, bg="silver")
...
class variables():
    def __init__(self, master):
        ...
        self.self.display_name = StringVar()
        self.self.display_phone = StringVar()
        self.self.display_address = StringVar()
